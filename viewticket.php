...
<title class="title">View Ticket</title>
<style>
.title{ 
        font-size: 40px;
		text-align:center; 
...
<tr><th colspan="2"align="CENTER">Ticket No. : <?php echo $r['ticketno'] ?></th></tr>
...
<a href="cancelticketredirect.php?ticketno=<?php echo $r['ticketno'];?>?username=<?php echo $qry['username'];?>"><input type="button" value="Cancel Booking"></a>
</tr>
<?php } ?>
<?php } ?>
</table>
