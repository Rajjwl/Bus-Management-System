...
<table class="text" width="498" border="0">
  ...
  <h3 align="right"><a href=login.php><img src="back.png" width="3%" /></a></h3>
  <tr>
  ...
  <tr>
    <td><input class="btn" type="password" name="textfield3" placeholder="Password" id="textfield3" required="required" /></td>
  </tr>
  <tr>
...
<td>
<select class="btn"  name="textfield6">
