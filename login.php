...
{ 
  ...
  {
	$res=mysql_query("select * from user where email = '$_POST[email]' and password= '$_POST[password]' ");
...
<table class="text"  border="0">
  ...
  <tr>
    <td><input class="btn1" type="submit" name="submit" value="LOGIN" /></td>
</tr>
<tr><td><h3 align="center" ><a href="Reg.php" >REGISTER NOW </a></h3></td></tr>
</table>
</form>
